...
<body style=" background-image: url('rastabg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>RASTA</h1>
   <br>
   <p class="fruitinfo">Stefan Đurić Rasta, Srpski reper, tekstopisac i kantautor.</p>
     <button type="button" class="btn btn-danger btn-lg">+33159357</button>
