...
<body style=" background-image: url('sasamaticbg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>SASA MATIC</h1>
   <br>
   <p class="fruitinfo">Saša Matić (26. april 1978. Drvar, Jugoslavija) je srbijanski pop-folk pjevač porijeklom iz Bosne i Hercegovine.</p>
     <button type="button" class="btn btn-danger btn-lg">+3876222987</button>
