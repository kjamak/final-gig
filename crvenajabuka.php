...
<body style=" background-image: url('crvenajabukabg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>CRVENA JABUKA</h1>
   <br>
   <p class="fruitinfo">Crvena jabuka je sarajevski pop rock sastav osnovan 1985. godine. Sada su stacionirani u Zagrebu u Hrvatskoj.</p>
     <button type="button" class="btn btn-danger btn-lg">+34789321</button>
