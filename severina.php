...
<body style=" background-image: url('severinabg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>SEVERINA</h1>
   <br>
   <p class="fruitinfo">Severina Kojić (Split, 21. travnja 1972.), hrvatska je pjevačica.</p>
     <button type="button" class="btn btn-danger btn-lg">+38762222988</button>
