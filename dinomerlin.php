...
<body style=" background-image: url('dinomerlinbg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>DINO MERLIN</h1>
   <br>
   <p class="fruitinfo">Edin Dervišhalidović (Sarajevo, 12. rujna 1962.) poznatiji kao Dino Merlin, bosanskohercegovački je pjevač rocka, etno popa i zabavne glazbe.</p>
     <button type="button" class="btn btn-danger btn-lg">+38762456789</button>
