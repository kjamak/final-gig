...
<body style=" background-image: url('jalabubabg.jpg'); ">
...
<div class="row">
  <div class="column leftclmn" data-aos="fade-right" data-aos-duration="2000">
    ...
    <img src="jalabuba1.png">
    <br><br>
  
</div>
  
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>JALA BRAT & BUBA CORELLI</h1>
   <br>
   <p class="fruitinfo">Jasmin Fazlić (Sarajevo, 16. listopada 1986.), poznatiji kao Jala Brat, bosanskohercegovački je pjevač i kantautor.Amar Hodžić (Sarajevo, 22. rujna 1989.), poznat kao Buba Corelli, bosanskohercegovački je reper i pjevač.</p>
  <p style="color: white;"> Booking available only for registered users</p> 
     <button type="button" class="btn btn-danger btn-lg">+35255488111</button>
