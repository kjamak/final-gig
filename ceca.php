...
<body style=" background-image: url('cecabg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>CECA</h1>
   <br>
   <p class="fruitinfo">Svetlana Ražnatović − Ceca (Žitorađa, 14. lipnja 1973.), srpska je pjevačica turbo-folk i pop-folk glazbe.</p>
     <button type="button" class="btn btn-danger btn-lg">+3485678998</button>
...
<div class="rowshop">
 ...
 <a href="milekitic.php" class="btn btn-warning">Book Now</a>
  ...
  <div class="card-body">
    ...
    <a href="ceca.html" class="btn btn-warning">Book Now</a>
  </div>
</div>
  </div>
...
<div class="columnshop" data-aos="zoom-in" data-aos-duration="3000">
  ...
  <div class="card-body">
    ...
    <a href="acopejovic.html" class="btn btn-warning">Book Now</a>
  </div>
</div>
  </div>
