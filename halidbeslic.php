...
<body style=" background-image: url('halidbeslicbg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>HALID BESLIC</h1>
   <br>
   <p class="fruitinfo">Halid Bešlić (Knežina, Sokolac; 20. studenoga 1953.), bosanskohercegovački pjevač narodne glazbe.</p>
     <button type="button" class="btn btn-danger btn-lg">+35147898898</button>
