...
<body style=" background-image: url('acopejovicbg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>ACO PEJOVIC</h1>
   <br>
   <p class="fruitinfo">Aleksandar Aco Pejović (Prijepolje, 18. april 1972) srpski je pop-folk pevač.</p>
     <button type="button" class="btn btn-danger btn-lg">+38765444589</button>
