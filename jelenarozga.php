...
<body style=" background-image: url('jelenarozgabg.jpg'); ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
     ...
     <div class="btn btn-outline-dark">Welcome : <i><?php echo $login_session; ?></i></div>&nbsp;
        <div class="btn btn-dark">+352147782</div>
  </div>
</nav>
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>JELENA ROZGA</h1>
   <br>
   <p class="fruitinfo">Jelena Rozga (Split, 23. kolovoza 1977.) je hrvatska pop pjevačica.</p>
     <button type="button" class="btn btn-danger btn-lg"><a style="text-decoration: none; color: white;" href="register.html">BOOK NOW</a></button>
