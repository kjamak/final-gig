...
<body style=" background-image: url('milekiticbg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>MILE KITIC</h1>
   <br>
   <p class="fruitinfo">Milojko "Mile" Kitić (Cerani, blizu Dervente, Bosna i Hercegovina, 1. siječnja 1952.), srpski je pop-folk pjevač.</p>
     <button type="button" class="btn btn-danger btn-lg">+38760123548</button>
