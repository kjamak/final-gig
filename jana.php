...
<body style=" background-image: url('janabg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>JANA</h1>
   <br>
   <p class="fruitinfo">Dragana Todorovic poznatija kao Jana, je srpska folk pjevacica rodjenda
 15. ožujka 1974.</p>
     <button type="button" class="btn btn-danger btn-lg">+3512266598</button>
