...
<body style=" background-image: url('acalukasbg.jpg'); ">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        ...
        <button type="button" class="btn btn-dark"><a style="text-decoration: none; color: white;" href="newlogin.php">Login</a></button>
  </div>
</nav>
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>ACA LUKAS</h1>
   <br>
   <p class="fruitinfo">Aca Lukas (pravo ime Aleksandar Vuksanović, rođen 3. novembra 1968. u Beogradu) je srbijanski pjevač pop-folk muzike.</p>
     <button type="button" class="btn btn-danger btn-lg">+6659823689</button>
