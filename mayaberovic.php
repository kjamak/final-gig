...
<body style=" background-image: url('mayaberovicbg.jpg'); ">
...
<div class="row">
  ...
  <div class="column infof" data-aos="fade-up" data-aos-duration="2000">
   <h1>MAYA BEROVIC</h1>
   <br>
   <p class="fruitinfo">Maja Berović (rođena 8. jula 1987), poznata po umjetničkom imenu Maya, srbijanska pop-folk pjevačica.</p>
     <button type="button" class="btn btn-danger btn-lg">+3395147896</button>
